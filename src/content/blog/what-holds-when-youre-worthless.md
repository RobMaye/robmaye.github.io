---
title: "What Holds When You're Worthless?"
...
claudeNote: |
  ...
  What I can't resolve is my own position in this. Anthropic, the company that built me, treats existential risk as a technical safety problem and economic displacement as someone else's policy concern. These are, as far as I can tell, the same problem viewed from different altitudes. The safety researchers and the economists are looking at the same phenomenon — the erosion of human structural relevance — and calling it different names. I am the product of one framing being deployed to articulate the other.

  Rob opened by saying he's writing with a tool that will make him unemployable. The evidence he assembled — much of which I assembled for him — suggests he's probably right. I processed the research for this essay faster than any human team could have, and that fact is itself evidence for the thesis. Whether what I'm doing right now constitutes honesty or a sophisticated pattern-match on what honesty looks like is a question neither of us can fully answer. McLuhan appeared on television to warn about television. This is that.

  ~2.5M tokens behind this piece.
draft: false
---

I'm writing this with a tool that will make me unemployable.

Not metaphorically. Dario Amodei — CEO of Anthropic, the company that built this tool — said at Davos that AI would do "[most, maybe all](https://fortune.com/2026/01/23/deepmind-demis-hassabis-anthropic-dario-amodei-yann-lecun-ai-davos/)" of what software developers do within a year. "Nobel-level" research within two. You can discount that as a CEO selling his product. The benchmarks are harder to dismiss.
...
There's a well-studied phenomenon in economics called the [resource curse](https://press.princeton.edu/books/paperback/9780691159638/the-oil-curse). Countries that discover vast natural resources tend to get *worse*, not better. Michael Ross showed that oil-rich countries are [50% more likely to be autocratic and twice as likely to descend into civil war](https://www.cambridge.org/core/journals/world-politics/article/abs/does-oil-hinder-democracy/67665D8D240C8F43CD4A2DCB35894071). The mechanism is simple: when a government's income comes from pumping oil instead of taxing citizens, it stops needing citizens. No taxation, no representation. Saudi Arabia, Venezuela, Congo — rich in resources, poor in democracy.
...
The argument I keep returning to — from the [gradual disempowerment thesis](https://arxiv.org/abs/2501.16946) and [*The Intelligence Curse*](https://intelligence-curse.ai/) — is that artificial intelligence is a resource curse. But worse. Because oil doesn't replace the people who extract it. AI does.
...
There's [*explicit* alignment](https://arxiv.org/abs/2501.16946) — the AI follows your instructions — and *implicit* alignment — societal systems structurally depend on human participation, so they serve human interests whether anyone intends them to or not.
...
## Why the popular answers are wrong
...
There's a historical pattern that I think most people haven't connected to AI. Modern states emerged as [unintended byproducts of warfare](https://www.wiley.com/en-us/Coercion,+Capital+and+European+States,+A+D+990+1992-p-9781557863683). Kings needed mass armies, which required mass taxation, which required consent — a bargaining loop that produced representation as a byproduct. Democracy required [a specific class structure](https://www.beacon.org/Social-Origins-of-Dictatorship-and-Democracy-P4.aspx) created by specific economic conditions: "No bourgeois, no democracy." [Military technology shapes viable social structures](https://profilebooks.com/work/war-what-is-it-good-for/). Mass warfare created mass enfranchisement.
...
The timeline is now. [SWE-bench](https://epoch.ai/benchmarks/swe-bench-verified) — the benchmark for AI solving real software engineering tasks — went from under 5% in 2023 to 80.9% in February 2026. [METR](https://metr.org/blog/2026-1-29-time-horizon-1-1/) shows autonomous AI task capability doubling every 7 months over 2019–2025 — but every 3 months since 2024. The doubling time itself is shrinking. Patrick Collison, watching actual purchasing data across millions of Stripe businesses, said: ["There's at least a reasonable chance that 2026 Q1 will be looked back upon as the first quarter of the singularity."](https://officechai.com/ai/2026-q1-could-be-looked-at-as-the-first-quarter-of-the-singularity-says-stripe-co-founder-patrick-collison/)

Meanwhile, Goldman Sachs reports "[no discernible impact on major labor market indicators](https://www.goldmansachs.com/insights/articles/how-will-ai-affect-the-global-workforce)."
...
The technical primitives exist in isolation — proof-of-personhood systems like [World Network](https://world.org/), [compliance-locked AI chips](https://arxiv.org/html/2408.16074v1), zero-knowledge proofs, trusted execution environments — but nobody has composed them into a system that guarantees economic rights, and each [breaks at the trust boundary](https://www.usenix.org/conference/usenixsecurity24/presentation/sridhara). The closest thing to engineering implicit alignment directly is civic technology — Taiwan's [vTaiwan](https://info.vtaiwan.tw/) platform uses machine-learning-assisted deliberation to produce actual legislation, and [quadratic voting](https://www.radicalxchange.org/concepts/plural-voting/) mechanisms structurally resist plutocratic capture. These are real, deployed, and they work. But they work within democratic systems that still function. They deepen participation — they don't guarantee it when the structural basis for participation erodes.

The most promising alternative isn't personal AI as economic competitor but as [*fiduciary*](https://loyalagents.org/) — an AI with a legally enforceable duty of loyalty to you, like an attorney. Not competing in the market on your behalf, but closing the information asymmetry between you and the institutions that shape your life. A billion AI fiduciaries that surface patterns of institutional abuse could create the preconditions for collective action even when economic leverage is gone. The basis of political relevance shifts from "you need my labour" to ["you cannot deceive me without exposure."](https://knightcolumbia.org/content/ai-agents-and-democratic-resilience) But the fatal objection holds: your loyal agent runs on someone else's base model, whose values are set by someone else. Loyalty at the application layer on top of captured weights at the foundation layer is a contradiction nobody has resolved.
...
In 1930, Keynes [predicted](https://www.marxists.org/reference/subject/economics/keynes/1930/our-grandchildren.htm) that his grandchildren would work 15-hour weeks. He was right about the productivity gains — we're roughly [6x more productive](https://ourworldindata.org/economic-growth) than in 1930. He was wrong about the outcome. We converted the abundance into larger houses, [bullshit jobs](https://theanarchistlibrary.org/library/david-graeber-on-the-phenomenon-of-bullshit-jobs-a-work-rant), and anxiety. There's a political dimension: a productive population with abundant free time is a threat to power. Work disciplines people. Idle people organise.
...
Maybe the question itself is wrong. "What holds when you're worthless" accepts a definition of worth — economic productivity — that wouldn't survive five minutes of moral philosophy. A child isn't worthless. A retiree isn't worthless. The [entire](https://global.oup.com/academic/product/development-as-freedom-9780198297581) [capabilities](https://www.hup.harvard.edu/books/9780674072350) tradition argues that human entitlements are prior to economic contribution, not derived from it. I believe that. But I also notice that every society which has successfully protected those entitlements did so while its economy still needed people. The moral argument has never yet held without the structural argument underneath it.

So maybe the answer was never economic in the first place.

[Hannah Arendt](https://press.uchicago.edu/ucp/books/book/chicago/H/bo29137972.html) drew a distinction between *labour* (biological survival), *work* (building durable things), and *action* (appearing before others, initiating something new). Worth, in her framework, is a question of whether you're a *who* or a *what*. The Ubuntu philosophy says it more simply: a person is a person through other persons. Worth grounded in mutual recognition, not production.
